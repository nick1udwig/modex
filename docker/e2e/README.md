...
- The compose service grants `SYS_ADMIN` plus unconfined seccomp and AppArmor profiles so Codex can create its normal read-only and workspace-write sandboxes inside Docker.
